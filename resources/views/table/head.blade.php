    ...
    <tr>
        ...
        @foreach($table->columns() as $column)
            <th
                ...
                class="@if($loop->first && $hasBulkActions) pr-6 @else px-6 @endif py-3 text-left rtl:text-right text-xs font-medium tracking-wide text-gray-500 dark:text-white {{ $column->classes }}"
            >
                @if($column->sortable)
