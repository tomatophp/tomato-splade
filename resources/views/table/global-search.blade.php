<div class="relative">
    <input
      class="block w-full sm:pl-9 text-sm rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 border-gray-200  dark:text-white dark:border-gray-600 dark:bg-gray-700 dark:placeholder-gray-400"
