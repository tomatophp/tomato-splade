<div class="flex flex-row sm:justify-end mb-3 px-4 sm:px-0 -mr-2 sm:-mr-3">
    ...
    <button
        ...
        type="button"
        class="w-48 order-6 sm:order-4 ml-auto mr-2 sm:mr-3 bg-white border rounded-md shadow-sm px-2.5 sm:px-4 py-2 inline-flex justify-center text-sm font-medium text-zinc-700 hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 border-zinc-300 dark:bg-zinc-700 dark:border-zinc-600 dark:hover:bg-zinc-600 dark:text-white"
    ...
    >
        ...
        <span class="ltr:ml-2 rtl:mr-2 hidden sm:inline">{{ __('Reset') }}</span>
    </button>
